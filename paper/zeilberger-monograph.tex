...
denominator. A guessing computation on $6000$ terms, reported by Kauers and Johansson on
the challenge page \cite{ZssytChallenge}, excludes every operator with
...
\bibitem{ZssytChallenge} D.~Zeilberger, \emph{Solid standard Young tableaux
challenges}, Personal Journal of S.~B.~Ekhad and D.~Zeilberger; exclusion
bound reported there as computed by M.~Kauers and F.~Johansson.
